...
# [1.5.0](https://github.com/akira-io/setup/compare/1.4.0...1.5.0) (2026-01-18)


### Features

* update release-it configuration to use `1.x` branch, simplify conventional changelog preset, and modify release hooks. ([0b4fa29](https://github.com/akira-io/setup/commit/0b4fa292efdd2b7fc5b47fa80355a6e5e6b20272))

# [1.4.0](https://github.com/akira-io/setup/compare/1.3.1...1.4.0) (2026-01-17)


### Features

* update release-it changelog header to include formatting and semantic versioning guidelines. ([d040253](https://github.com/akira-io/setup/commit/d04025385877b23dc75000cd1cfe2dcea3839a05))

## [1.3.1](https://github.com/akira-io/setup/compare/1.3.0...1.3.1) (2026-01-17)
