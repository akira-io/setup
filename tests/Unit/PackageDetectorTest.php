...
it('returns npm when no package manager is found', function () {
...
it('detects bun when available', function () {
    $executableFinder = new class extends ExecutableFinder {
        public function find(string $name, ?string $default = null, array $extraDirs = []): ?string
        {
...
it('detects pnpm when bun not available', function () {
    $executableFinder = new class extends ExecutableFinder {
        public function find(string $name, ?string $default = null, array $extraDirs = []): ?string
        {
...
it('detects yarn when bun and pnpm not available', function () {
    $executableFinder = new class extends ExecutableFinder {
        public function find(string $name, ?string $default = null, array $extraDirs = []): ?string
        {
...
it('detects npm when only npm available', function () {
    $executableFinder = new class extends ExecutableFinder {
        public function find(string $name, ?string $default = null, array $extraDirs = []): ?string
        {
...
it('can be instantiated with custom ExecutableFinder', function () {
...
it('returns correct command for default case in match', function () {
    $detector = new PackageDetector();
