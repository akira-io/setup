...
it('trait can be used in a command class', function () {
...
it('trait has collectUserChoices method', function () {
    $command = new class extends Command {
        use CollectsUserChoices;
...
it('collectUserChoices method returns PackageSelection', function () {
...
it('collectUserChoices method is private', function () {
    $reflection = new ReflectionMethod(new class extends Command {
        use CollectsUserChoices;
...
it('trait requires packageDetector property', function () {
...
it('collectUserChoices uses correct prompt functions', function () {
...
it('collectUserChoices uses all enum classes', function () {
    $source = file_get_contents(__DIR__ . '/../../../../src/Console/Concerns/CollectsUserChoices.php');
...
it('collectUserChoices checks for package.json', function () {
    $source = file_get_contents(__DIR__ . '/../../../../src/Console/Concerns/CollectsUserChoices.php');
    
    expect($source)->toContain('hasPackageJson()');
});

it('collectUserChoices detects node package manager', function () {
    $source = file_get_contents(__DIR__ . '/../../../../src/Console/Concerns/CollectsUserChoices.php');
    
    expect($source)->toContain('detectNodePackageManager()');
});

it('collectUserChoices returns PackageSelection instance', function () {
    $source = file_get_contents(__DIR__ . '/../../../../src/Console/Concerns/CollectsUserChoices.php');
    
    expect($source)->toContain('return new PackageSelection(');
});

it('collectUserChoices initializes defaults correctly', function () {
    $source = file_get_contents(__DIR__ . '/../../../../src/Console/Concerns/CollectsUserChoices.php');
...
it('collectUserChoices provides correct package manager options', function () {
    $source = file_get_contents(__DIR__ . '/../../../../src/Console/Concerns/CollectsUserChoices.php');
...
it('collectUserChoices has proper type annotations', function () {
    $source = file_get_contents(__DIR__ . '/../../../../src/Console/Concerns/CollectsUserChoices.php');
...
it('collectUserChoices casts select result to string', function () {
    $source = file_get_contents(__DIR__ . '/../../../../src/Console/Concerns/CollectsUserChoices.php');
    
    expect($source)->toContain('(string) select(');
});

it('collectUserChoices sets confirm default to true', function () {
    $source = file_get_contents(__DIR__ . '/../../../../src/Console/Concerns/CollectsUserChoices.php');
